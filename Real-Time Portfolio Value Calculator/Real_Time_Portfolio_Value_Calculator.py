...
def lightChange():
    ...
    while ((startTime<currentDT.hour) and (startTime<16)):
        ...
        hourIndex+=1
        startTime+=1
    #while loop that runs through number of indexes in portfolio and changes lights accordingly (needs to compare to starting value somehow)
